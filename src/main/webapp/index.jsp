...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li class="nav-items"><a href="#">JEFF BEZOS</a></li>
    ...
    <div class="movies-list">
        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Avengers Endgamee</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Dark Phoenixx</h2>
                    <h6 class="des">Lorem ipsum dolor sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
